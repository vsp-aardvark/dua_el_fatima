$(document).ready(function() {
 ...
 var searchOption = "<option></option>";
   reciter = "Mir Hassan Mir"
 		searchOption += "<optgroup label="+reciter.replace(" ", "-")+">";
    	var year  = "2019";
		...
		mir20199:"Zainab gale ko choom le"
			...
			searchOption +="<optgroup label="+year+">";
			for(var nouha in mirnoha){
		        searchOption+="<option id=\""+reciter+"/"+year+"/"+mirnoha[nouha]+"\">"+mirnoha[nouha]+"</option>";
		        }
		      searchOption+="</optgroup>"
    	var year = "2018";
    ...
    reciter = "Meesam Abbas"
		...
		var year = "2004";
			...
			for(var nouha in mirnoha){
		      ...
		      searchOption+="</optgroup>"
		       searchOption+="</optgroup>"
    reciter = "Ameer Hassan Amir"
    	searchOption += "<optgroup label="+reciter.replace(" ", "-")+">";
    	var year = "2017";
		
		var mirnoha={n43849:"Abbas Bohot dushwari hai", n43850:"Aye imam e raza", n43851:"Chand rota raha", n43852:"Jab hamein laya gaya shaam ke bazaro mein", n43853:"Khoon-e-hussain", n43854:"Mera bhaiyya akbar salamat rahe", n43855:"Mujhe shabbir kehte hai", n43856:"Rang layega zaroor", n43857:"Sakina pani aaya hai", n43858:"So ja sakina"};
...
$(document).on("change",".js-example-basic-multiplenouhay",function(){
  var url= this.options[this.selectedIndex].id;
      window.location.href="nouhaLyrics.html?lyrics/nouhay/"+url;
